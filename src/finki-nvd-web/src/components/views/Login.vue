  ...
  <div class="icon-container d-flex align-items-center">
    ...
    <div class="card rounded-4 m-auto" style="width: 24rem;">
      <div class="card-header">
        <h1 class="card-title text-center user-select-none">LOGIN</h1>
      </div>
      ...
      <div class="card-body mx-auto">
        ...
        <button class="btn btn-secondary mx-3" @click="redirectRegister">Register</button>
      </div>
    </div>
      ...
      .catch((error) => {
        ...
        switch (error.code) {
          ...
          case "auth/user-not-found":
            errorMsg.value = "No existing account with this email";
            break;
